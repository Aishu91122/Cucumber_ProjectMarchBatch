...
public class Groups {
	...
	@Test(priority = -1, invocationCount = 5, groups = "smoke")
	public void getURL() {
		System.out.println(driver.getCurrentUrl());
	}

	@Test(priority = 0, description = "Title of the Current Page", groups = "smoke")
	public void getTitle() {
		System.out.println(driver.getTitle());
	}

	@Parameters({ "uN", "pW" })
	@Test(priority = 4, description = "Login Module", groups = "sanity")
	...
	@Test(priority = 1, groups = "regression", dependsOnGroups = "sanity" )
	...
	@Parameters({ "tags" })
	@Test(priority = 0, alwaysRun = true, groups = "sanity" )
